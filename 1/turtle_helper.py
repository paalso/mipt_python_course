...
def draw_polygon(turtle, angles, side, start_angle, sector_angle = 360):
...
def draw_arc(turtle, radius, start_angle, sector_angle = 180):
    ANGLES = 70

    side = 2 * radius * math.sin(math.radians(360 / (2 * ANGLES)))
    draw_polygon(turtle, ANGLES, side, start_angle, sector_angle)
